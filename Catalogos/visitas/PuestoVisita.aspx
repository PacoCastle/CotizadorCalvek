<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PuestoVisita.aspx.cs" Inherits="Catalogos_visitas_Departamentos" Title="VISITAS-PUESTO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table style="width: 814px">
        <tr>
            ...
            <td style="height: 20px">
                <asp:Label ID="lblEtiquetaTitulo" runat="server" Text="Puestos"></asp:Label>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <tr>
            ...
            <td style="height: 101px">
                <asp:GridView ID="gvwSolicitudApoyo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    DataKeyNames="PuestoId" DataSourceID="sdsPuestoVisitas" Font-Size="9pt"
                    ForeColor="#333333" GridLines="None" ShowFooter="True" Height="130px" Width="327px" OnRowCommand="GridView1_RowCommand1">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundField DataField="PuestoId" HeaderText="Id" InsertVisible="False"
                            SortExpression="PuestoId" />
                ...
                <asp:SqlDataSource ID="sdsPuestoVisitas" runat="server" ConnectionString="<%$ ConnectionStrings:cotizadorCS %>"
                    DeleteCommand="update Puestos set activo = 0 &#13;&#10;where PuestoId = @PuestoId"
                    InsertCommand="insert into Puestos(nombre,activo) values(@nombre,1)"
                    SelectCommand="get_listaPuestoVisita" SelectCommandType="StoredProcedure">
                    <SelectParameters>
