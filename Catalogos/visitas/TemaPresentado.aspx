<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TemaPresentado.aspx.cs" Inherits="Catalogos_visitas_Departamentos" Title="VISITAS-TEMAS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table style="width: 814px">
        <tr>
            ...
            <td style="height: 20px">
                <asp:Label ID="lblEtiquetaTitulo" runat="server" Text="Temas Presentados"></asp:Label>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <tr>
            ...
            <td style="height: 101px">
                <asp:GridView ID="gvwSolicitudApoyo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    DataKeyNames="temaPresentadoId" DataSourceID="sdsTemaPresentadoVisitas" Font-Size="9pt"
                    ForeColor="#333333" GridLines="None" ShowFooter="True" Height="130px" Width="327px" OnRowCommand="GridView1_RowCommand1">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundField DataField="temaPresentadoId" HeaderText="Id" InsertVisible="False"
                            SortExpression="temaPresentadoId" />
                ...
                <asp:SqlDataSource ID="sdsTemaPresentadoVisitas" runat="server" ConnectionString="<%$ ConnectionStrings:cotizadorCS %>"
                    DeleteCommand="update TemaPresentado set activo = 0 &#13;&#10;where temaPresentadoId = @temaPresentadoId"
                    InsertCommand="insert into TemaPresentado(nombre,activo) values(@nombre,1)"
                    SelectCommand="get_listaTemaPresentado" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                    ...
                    <DeleteParameters>
                        <asp:Parameter Name="temaPresentadoId" />
                    </DeleteParameters>
                    <InsertParameters>
