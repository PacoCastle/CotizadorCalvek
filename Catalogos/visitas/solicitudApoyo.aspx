<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="solicitudApoyo.aspx.cs" Inherits="Catalogos_visitas_Departamentos" Title="VISITAS-SOLICITUDAPOYO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table style="width: 814px">
        <tr>
            ...
            <td style="height: 20px">
                <asp:Label ID="lblEtiquetaTitulo" runat="server" Text="Solicitud Apoyo"></asp:Label>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <tr>
            ...
            <td style="height: 101px">
                <asp:GridView ID="gvwSolicitudApoyo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    DataKeyNames="solicitudApoyoId" DataSourceID="sdsSolicitudApoyoVisitas" Font-Size="9pt"
                    ForeColor="#333333" GridLines="None" ShowFooter="True" Height="130px" Width="327px" OnRowCommand="GridView1_RowCommand1">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundField DataField="solicitudApoyoId" HeaderText="Id" InsertVisible="False"
                            SortExpression="solicitudApoyoId" />
                ...
                <asp:SqlDataSource ID="sdsSolicitudApoyoVisitas" runat="server" ConnectionString="<%$ ConnectionStrings:cotizadorCS %>"
                    DeleteCommand="update solicitudApoyoVisita set activo = 0 &#13;&#10;where solicitudApoyoId = @solicitudApoyoId"
                    InsertCommand="insert into solicitudApoyoVisita(nombre,activo) values(@nombre,1)"
                    SelectCommand="get_listaSolicitudApoyoVisita" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                    ...
                    <DeleteParameters>
                        <asp:Parameter Name="solicitudApoyoId" />
                    </DeleteParameters>
                    <InsertParameters>
