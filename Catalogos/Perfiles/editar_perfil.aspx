<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="editar_perfil.aspx.cs" Inherits="Catalogos_Perfiles_editar_perfil" Title="PERFILES" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
  ...
  <asp:sqldatasource
      ...
      <asp:sqldatasource
        ...
        runat="server"
        connectionstring="<%$ ConnectionStrings:KEPLER %>"
        selectcommand="select C3,C2 from KDUV order by C2">
      </asp:sqldatasource>
    ...
    <asp:sqldatasource
        ...
        selectcommand="select PUESTO_PACIENTE,DESC_PACIENTE from TU_PER_CAT_PUESTOPAC ORDER BY PUESTO_PACIENTE">
      </asp:sqldatasource>
...
<div class="container">
        ...
        <div class="row">
                ...
                <div class="col-sm-10">
                <asp:TextBox ID="txtRechargeDate" runat="server" class="form-control" type="text" placeholder="DD-MM-YYYY" ReadOnly="True"></asp:TextBox>
                <asp:RequiredFieldValidator runat="server" id="reqfecha" controltovalidate="txtRechargeDate" errormessage="Selecciona una Fecha" SetFocusOnError="True" />
                </div>
         ...
         <div class="form-group">
                ...
                <div class="col-sm-3">
                    <asp:TextBox ID="txtEmpresaPerfil" class="form-control" runat="server" type="text" placeholder="EMPRESA"></asp:TextBox>
                ...
                <div class="col-sm-10">
                    <asp:TextBox ID="txtContacto" class="form-control" runat="server" type="text" placeholder="CONTACTO"></asp:TextBox>
             ...
             <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <cc1:FilteredTextBoxExtender ID="ftbeNoPedimento" runat="server" FilterType="Numbers" TargetControlID="txtTelefono"></cc1:FilteredTextBoxExtender>
                ...
                <div class="col-sm-4">
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtextension"></cc1:FilteredTextBoxExtender>
                </div>
                </div>
          ...
          <div class="form-group">
                ...
                <div class="col-sm-4">
                    <asp:TextBox ID="txtNombrePerfil" class="form-control" runat="server" type="text" placeholder="NOMBRE PERFIL"></asp:TextBox>
                ...
                <div class="col-sm-4">
                      ...
                      <asp:ListItem Value="ESPECIAL">ESPECIAL</asp:ListItem>
                       ...
                       <asp:RequiredFieldValidator id="RequiredFieldValidator4" Text="Selecciona el Tipo de Perfil" InitialValue="0" ControlToValidate="listatipoperfil" Runat="server" SetFocusOnError="True" BorderStyle="NotSet" />
                </div>
                </div>
                ...
                <div class="col-sm-4">
                    <asp:TextBox ID="txtProyectoPerfil" class="form-control" runat="server" type="text" placeholder="PROYECTO"></asp:TextBox>
                ...
                <div class="col-sm-4">
                    ...
                    <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator2" controltovalidate="txtTipoExamen" errormessage="Escribe el Tipo de Examen" SetFocusOnError="True" />
                </div>
                </div>
                ...
                <div class="col-sm-4">
                      ...
                      <asp:ListItem Value="NO APLICA">NO APLICA</asp:ListItem>
                       ...
                       <asp:RequiredFieldValidator id="RequiredFieldValidator5" Text="Selecciona el Tiempo de Entrega Electronico" InitialValue="0" ControlToValidate="listaTEE" Runat="server" SetFocusOnError="True" BorderStyle="NotSet" />
                </div>
                ...
                <div class="col-sm-4">
                      ...
                      <asp:ListItem Value="AMBOS">AMBOS</asp:ListItem>
                       ...
                       <asp:RequiredFieldValidator id="RequiredFieldValidator6" Text="Selecciona la forma de Entrega" InitialValue="0" ControlToValidate="listaformaentrega" Runat="server" SetFocusOnError="True" BorderStyle="NotSet" />
                </div>
                ...
                <div class="col-sm-4">
                      ...
                      <asp:ListItem Value="SOLO EVALUACIONES">SOLO EVALUACIONES</asp:ListItem>
                       ...
                       <asp:RequiredFieldValidator id="RequiredFieldValidator7" Text="Selecciona el Formato de Reporte" InitialValue="0" ControlToValidate="listformatoreporte" Runat="server" SetFocusOnError="True" BorderStyle="NotSet" />
                </div>
                </div>
        ...
        <div class="form-group">
             <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="txtagregar" class="form-control" runat="server" type="text" placeholder="OTRO EXAMEN" validationgroup="agregar"></asp:TextBox>
                    ...
                    <div class="col-sm-2">
                          <asp:Button ID="Button1" runat="server" validationgroup="agregar" style="background-color:DodgerBlue;" class="form-control" ForeColor="White" Text="AGREGAR" OnClick="Agregar_Examen" Font-Size="Medium" />
                    </div>
               </div>
             ...
             <div class="row">
               ...
               <div class="form-group"><br><br>
                    <div class="row">
                       <div class="col-sm-6">
                          <asp:Button ID="btnLimpiar" runat="server" style="background-color:DarkGray;" class="form-control" ForeColor="Teal" Text="Limpiar" OnClick="btnLimpiar_Click"/>
                       </div>
                       <div class="col-sm-6">
                       <asp:Button ID="btnActualizar" runat="server" style="background-color:DarkGray;" class="form-control" ForeColor="Teal" Text="ACTUALIZAR" OnClick="BtnActualizar"/>
