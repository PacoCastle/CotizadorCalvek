...
public partial class Catalogos_Perfiles_AltaPerfiles : System.Web.UI.Page
{
    ...
    private string nombre_examen_agregar;
    ...
    private int ex_medico, ex_audiometria, ex_espirometria, ex_compimetria, ex_ecg, ex_tox3, ex_tox5, ex_tox6, ex_perfilcardiaco, ex_exudadofaringeo,
                ...
                ex_consulta, ex_otros, id_asesor_bd;
    ...
    protected void btnGuardar_Click1(object sender, EventArgs e)
    {
        ...
        this.fecha = Convert.ToDateTime(((HiddenField)Master.FindControl("hdnDate")).Value);
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["cotizadorCS"].ToString()))
             {
                 ...
                 {
                     con.Open();
                     cmd.Parameters.AddWithValue("@PERF_DESCRIPCION", this.nombre_perfil.ToUpper());
                     ...
                     cmd.Parameters.AddWithValue("@CONTACTO", this.contacto.ToUpper());
                     //cmd.Parameters.AddWithValue("@EMAIL", this.email);
                     //cmd.Parameters.AddWithValue("@TELEFONO", this.telefono);
                     cmd.Parameters.AddWithValue("@TIEMPO_ENTREGA_ELECT", this.TE.ToUpper());
                     cmd.Parameters.AddWithValue("@TIEMPO_ENTREGA_FISICO", this.TF.ToUpper());
                     cmd.Parameters.AddWithValue("@GENERO", this.genero.ToUpper());
                     cmd.Parameters.AddWithValue("@PUESTO_PACIENTE", this.puesto.ToUpper());
                     cmd.Parameters.AddWithValue("@ENTREGA_DE_EXP", this.entrega_expediente.ToUpper());
                     cmd.Parameters.AddWithValue("@TIPO_EXAMEN", this.tipo_examen.ToUpper());
                     cmd.Parameters.AddWithValue("@ID_EMPRESA", this.cliente);
                     cmd.Parameters.AddWithValue("@EMPRESA2", this.empresa_perfil.ToUpper());
                     cmd.Parameters.AddWithValue("@PROYECTO", this.proyecto_perfil.ToUpper());
                     ...
                     cmd.Parameters.AddWithValue("@TIPO_PERFIL", this.listtipoperfil.ToUpper());
                     cmd.Parameters.AddWithValue("@FORMATO_REPORTE", this.listreporte.ToUpper());
             ...
             lblModalBody.Text = "SE HA DADO DE ALTA EL PERFIL: " + this.nombre_perfil.ToUpper();
    ...
    }//fin de guardar perfil

    protected void btnLimpiar_Click(object sender, EventArgs e)
    {
        lstAsesor.SelectedIndex = -1;
        listcliente.SelectedIndex = -1;
        txtContacto.Text = "";
        txtEmail.Text = "";
        txtTelefono.Text = "";
        txtNombrePerfil.Text = "";
        txtEmpresaPerfil.Text = "";
        txtProyectoPerfil.Text = "";
        listaTEE.SelectedIndex = -1;
        txtTF.Text = "";
        listaformaentrega.SelectedIndex = -1;
        txtTipoExamen.Text = "";
        ...
        listformatoreporte.SelectedIndex = -1;
        listatipoperfil.SelectedIndex = -1;
        foreach (RepeaterItem item in Repeater1.Items)
        {
            if (item.ItemType == ListItemType.Item || item.ItemType == ListItemType.AlternatingItem)
            {
                var checkBox = (CheckBox)item.FindControl("chkbx");
    ...
    {
        Response.Redirect("AltaPerfiles.aspx");
    }

    public string GenerarIdperfil()
    {
        int longitud = 5;
