    ...
    <table border="0" cellpadding="0" cellspacing="0" width="800">
      ...
      <tr>
        ...
        <tr>
            ...
            DataSourceID="SqlDataSource1" Font-Size="7pt" ForeColor="#333333" GridLines="None"
            Width="473px" AllowPaging="True" Visible="False" PageSize="5" DataKeyNames="Serie,Folio" onrowupdating="GridView1_RowUpdating">
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <Columns>
                <asp:TemplateField HeaderText="Folio" SortExpression="Folio">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Serie") %>'></asp:Label>-<asp:Label
                            ID="Label14" runat="server" Text='<%# Bind("Folio") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Monto" SortExpression="Monto">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Estatus" SortExpression="Estatus">
                    <EditItemTemplate>
                        <asp:DropDownList ID="idEstatus" runat="server" DataSourceID="odsBdOperacion2"
                DataTextField="estatusCobranza" DataValueField="idEstatusCobranza" Font-Size="7pt">
            ...
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BDOPERACION2009 %>"
                    SelectCommand="select rtrim(ltrim(ccc.tp_serie)) as Serie,&#13;&#10;convert(varchar(9),ccc.tp_folio) as Folio,&#13;&#10;&#9;round(sum(ccc.nu_totalpm),2) as Monto,&#13;&#10;&#9;isnull(round(sum(ccc.nu_depositomn),2),0) as Abono,&#13;&#10;&#9;ccc.cd_estatus as idEstatus,&#13;&#10;&#9;replace(replace(replace(replace(replace(ccc.tp_unidadnegocio,'CELAYA','CEL'),'(Ninguna)','---'),'SAN LUIS POTOSI','SLP'),'CALVEK','AUT'),'QUERETARO','QRO') as UnidadNegocio,&#13;&#10;&#9;'++++++++++++' AS Comision,&#13;&#10;&#9;tec.NB_ESTATUSCOB as Estatus&#13;&#10;from BD_OPERACION2009.DBO.TU_CG_COBRANZACALVEK ccc,&#13;&#10;&#9; BD_OPERACION2009.DBO.TD_estatusCobranza tec&#13;&#10;where ccc.cd_estatus = tec.CD_ESTATUSCOB&#13;&#10;and (@intFolio = 0 or ccc.tp_folio = @intFolio)&#13;&#10;and (@intCliente = 0 or ccc.cd_cliente = @intCliente)&#13;&#10;and (@intAgente = 0 or ccc.cd_agente = @intAgente)&#13;&#10;and (@intEstatusCob = -1 or ccc.cd_estatus = @intEstatusCob)&#13;&#10;and (@intRangoDias=0 or ISNUMERIC(ccc.rango_dias)=1 AND ccc.rango_dias = @intRangoDias)&#13;&#10;group by ccc.tp_folio,&#13;&#10;&#9;ccc.tp_serie,&#13;&#10;&#9;ccc.cd_estatus,&#13;&#10;&#9;ccc.tp_unidadnegocio,&#13;&#10;&#9;tec.NB_ESTATUSCOB&#13;&#10;"
                    UpdateCommand="update TH_ABONOS2009 set cd_estatus=@idEstatus&#13;&#10;where tp_serie = @Serie&#13;&#10;and tp_folio = @Folio&#13;&#10;&#13;&#10;">
                    <SelectParameters>
