                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Documento" SortExpression="folioDocumento">
                            <EditItemTemplate>
                                Serie &nbsp; Folio<br />
                                <asp:TextBox ID="serieDocumento" runat="server" Font-Size="9pt" Text='<%# Bind("serieDocumento") %>'
                                    Width="30px" Height="13px"></asp:TextBox>
                                <asp:TextBox ID="folioDocumento" runat="server" Font-Size="9pt" Height="13px" Text='<%# Bind("folioDocumento") %>'
                        ...
                        <asp:TemplateField HeaderText="FechaPrevista" SortExpression="fechaEntrega">
                            <EditItemTemplate>
                                <span style="font-size: 7pt">DD/MM/AAAA<br />
                                </span><asp:TextBox ID="fechaEntrega" runat="server" Font-Size="9pt" Text='<%# Bind("fechaEntrega") %>'
                                    Width="92px" Height="13px"></asp:TextBox><span style="font-size: 7pt"></span><asp:RegularExpressionValidator ID="RegularExpressionValidator2"
                                    runat="server" ControlToValidate="fechaEntrega" ErrorMessage="fecha invalida: dd/mm/aaaa"
                                    Font-Size="10pt" ValidationExpression="^((([0][1-9]|[12][\d])|[3][01])[-\/]([0][13578]|[1][02])[-\/][1-9]\d\d\d)|((([0][1-9]|[12][\d])|[3][0])[-\/]([0][13456789]|[1][012])[-\/][1-9]\d\d\d)|(([0][1-9]|[12][\d])[-\/][0][2][-\/][1-9]\d([02468][048]|[13579][26]))|(([0][1-9]|[12][0-8])[-\/][0][2][-\/][1-9]\d\d\d)$"></asp:RegularExpressionValidator>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="FechaConfirmada" SortExpression="fechaConfirmada">
                            <EditItemTemplate>
                                <span style="font-size: 7pt">DD/MM/AAAA<br />
                                    <asp:TextBox ID="fechaConfirmada" runat="server" Font-Size="9pt" Height="13px" Text='<%# Bind("fechaConfirmada") %>'
                        ...
                        <asp:TemplateField HeaderText="Comentario" SortExpression="comentario">
                            <EditItemTemplate>
                                <asp:TextBox ID="comentario" runat="server" Text='<%# Bind("comentario") %>' Width="206px" Height="13px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Acciones" SortExpression="acciones">
                            <EditItemTemplate>
                                <asp:DropDownList ID="temporal" runat="server" DataSource='<%# ListaEstatus(Eval("Instruccion").ToString()) %>'  >
                                </asp:DropDownList>
                                <asp:Label ID="Label17" runat="server" Text='<%# Bind("Instruccion") %>' Visible="False"></asp:Label>
        ...
        <tr>
            <td colspan="4" style="height: 5px">
                ...
                <asp:ObjectDataSource ID="odsDocumentoDestino" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetData" TypeName="ConsultasConKeplerTableAdapters.get_datosDestPedidoKeplerTableAdapter">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="strSerie" QueryStringField="serie" Type="String" />
                ...
                <div style="overflow: auto; width: 950px; height: 350px" >
                    ...
                    GridLines="None" Visible="False" Width="900px" onRowDataBound="gvDocDestino_RowDataBound">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundField DataField="partida" HeaderText="#" ReadOnly="True" SortExpression="partida" >
                        ...
                        <asp:BoundField DataField="CantidadPedido" HeaderText="Cant." ReadOnly="True"
                            SortExpression="CantidadPedido">
                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="pendientesPedido" HeaderText="Pdtes." ReadOnly="True"
                            SortExpression="pendientesPedido">
                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Destino" SortExpression="Movimiento">
                            <EditItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Movimiento") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td colspan="2" style="height: 16px">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("Movimiento") %>' Width="150px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 14px">
                                        ...
                                        <td>
                                            <asp:Label ID="lblDestino2" runat="server" Font-Bold="False" Font-Italic="False"
                                                ForeColor="#000099" Text='<%# Bind("Movimiento2") %>' Visible="False" Width="137px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Serie" SortExpression="Serie">
                            <EditItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("Serie") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate><table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("Serie") %>'></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 14px">
                                        &nbsp; &nbsp; &nbsp;
                                    ...
                                    <td >
                                    <asp:Label ID="lblSerie2" runat="server" Text='<%# Eval("Serie2") %>' ForeColor="#000099" Visible="False"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Folio" SortExpression="Folio">
                            <EditItemTemplate>
                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Folio") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate><table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("Folio") %>'></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 14px">
                                        &nbsp; &nbsp;&nbsp;</td>
                                    <td>
                                <asp:Label ID="lblFolio2" runat="server" Text='<%# Bind("Folio2") %>' ForeColor="#000099" Visible="False"></asp:Label>
                                </td>
                                </tr>
                            </table>
                            </ItemTemplate>
                            ...
                            <ItemTemplate><table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="width: 14px">
                                        &nbsp; &nbsp;&nbsp;</td>
                                    <td>
                                <asp:Label ID="lblFecha2" runat="server" Text='<%# Bind("Fecha2") %>' ForeColor="#000099" Visible="False"></asp:Label>
                                </td>
                                </tr>
                            </table>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Cantidad" SortExpression="CantidadDestino">
                            <EditItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("CantidadDestino") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate><table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("CantidadDestino") %>'></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 14px">
                                        &nbsp; &nbsp;&nbsp;</td>
                                    <td>
                                <asp:Label ID="lblCantidad2" runat="server" Text='<%# Bind("Cantidad2") %>' ForeColor="#000099" Visible="False"></asp:Label></td>
                                </tr>
                            </table>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
