<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DocsSinPoliza.aspx.cs" Inherits="Admin_Contabilidad_DocsSinPoliza" Title="Documentos Sin Poliza" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table id="TABLE1">
        <tr>
            <td align="center" style="width: 660px">
                <asp:Label ID="Label1" runat="server" Text="Documentos Sin Poliza"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 515px">
                <asp:GridView ID="GridDoc" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    CellPadding="4" DataSourceID="DocSinP" Font-Size="8pt" ForeColor="#333333" GridLines="None"
                    PageSize="15" Visible="False" Width="539px" EnableModelValidation="True">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundField DataField="suc" HeaderText="SUCURSAL">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="C2" HeaderText="GÉNERO">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="C3" HeaderText="NATURALEZA" />
                        <asp:BoundField DataField="C4" HeaderText="GRUPO">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="C5" HeaderText="TIPO" />
                ...
                <asp:SqlDataSource ID="DocSinP" runat="server" ConnectionString="<%$ ConnectionStrings:TUDATOPER2009 %>"
                    ProviderName="<%$ ConnectionStrings:TUDATOPER2009.ProviderName %>" SelectCommand="get_documentos_sinpoliza"
